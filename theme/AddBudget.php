                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">          
                                            <input type="text" class="form-control" id="Desc" placeholder="ProjectDescription" name="Desc">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">          
                                            <input type="text" class="form-control" id="Year" placeholder="ProjectYear" name="Year">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">          
                                            <input type="text" class="form-control" id="SchedulePassedBy" placeholder="SchedulePassedBy" name="SchedulePassedBy">
                                          </div>
                                        </div><br>
                                        <div class="form-group">        
                                          <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" style=" color:white;" name="save" id="save" class="btn btn-default bg-primary">Submit</button>
                                          </div>
                                        </div>
                                      </form>
</div>
